...
//        for(int i = 0; i < super.getChoices().length; i++) {
              ...
              missingAnswers = findMissingCorrectAnswers(givenAnswer);

              incorrectAnswers = findIncorrectGivenAnswers(givenAnswer);

//        }

             

              pointsEarned -= missingAnswers;

              pointsEarned -= incorrectAnswers;
